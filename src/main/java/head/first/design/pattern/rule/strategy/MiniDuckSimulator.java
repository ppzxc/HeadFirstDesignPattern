package head.first.design.pattern.rule.strategy;

import head.first.design.pattern.rule.strategy.dp.FlyRocketPowered;
import head.first.design.pattern.rule.strategy.impl.Duck;
import head.first.design.pattern.rule.strategy.impl.MallardDuck;
import head.first.design.pattern.rule.strategy.impl.ModelDuck;
import head.first.design.pattern.rule.strategy.impl.RubberDuck;
